<script lang="ts">
  ...
  function addToCart(qty = 1) {
    ...
    const item: CartItem = {
      ...
      price: $isWholesale ? ((currentVariant.wholesale_price && currentVariant.wholesale_price > 0) ? currentVariant.wholesale_price : currentVariant.price * (1 - WHOLESALE_DISCOUNT)) : currentVariant.price,
        ...
        <div class="flex flex-col">
          ...
          <div class="flex items-baseline gap-4 mb-2">
            <span class="text-3xl md:text-4xl font-serif text-primary">
              ${($isWholesale ? ((currentVariant?.wholesale_price && currentVariant.wholesale_price > 0) ? currentVariant.wholesale_price : (currentVariant?.price || 0) * (1 - WHOLESALE_DISCOUNT)) : (currentVariant?.price || 0)).toFixed(2)}
            </span>
            {#if $isWholesale}
